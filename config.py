...
MAX_TURNS = max(20, int(os.getenv("MAX_TURNS", "20")))
...
SYSTEM_PROMPT = (
    ...
    "如果任务涉及 PPT 生成、编辑、分析或转换，必须优先走 pptx skill 提供的白名单路径，只能使用 skill 文档和工具白名单里允许的命令；不要为了图省事临时改用 python -c、python-pptx 或其他未批准脚本。\n"
